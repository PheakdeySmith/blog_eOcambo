...
<html lang="en" class="no-js">
    <head>
        ...
        <meta name="description" content="&amp;lt;p&amp;gt;&amp;lt;strong&amp;gt;IMPORTANT: this template is for Ghost CMS not Wordpress. We don’t offer re...">
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('assets') }}/css/plugins.min.css" as="style" onload="this.rel='stylesheet';">
        <link rel="stylesheet" type="text/css" href="{{ asset('assets') }}/css/cards.min.css">
        <link rel="stylesheet" href="{{ asset('assets') }}/index-a9b4110996ce191cf79c3c3d4591a5bb3ada6179f9cdd9de9e89ba0bd13823e0.css" media="all">
        <link rel="stylesheet" href="{{ asset('assets') }}/index-457550c0311c719db250e79989e7462091be593549fb6bcb3801c9182189d1e5.css" media="all">
        ...
        <script async src="{{ asset('assets') }}/analytics.js"></script>
        <script defer src="{{ asset('assets') }}/js/portal.min.js" data-i18n="false"
        ...
        <script defer src="{{ asset('assets') }}/js/sodo-search.min.js" data-key="3418b12091e67d20ee9d637bf3"
        ...
        <script defer src="{{ asset('assets') }}/js/comment-counts.min.js"
            data-ghost-comments-counts-api="https://ghost.estudiopatagon.com/zento/members/api/comments/counts/"></script>
        <script defer src="{{ asset('assets') }}/js/member-attribution.min.js"></script>
        <script src="{{ asset('assets') }}/'js/index-70.js'"></script>

        <script>
            var calcHeight = function () {
                var headerDimensions = document.querySelector('.preview__header').offsetHeight;
                document.querySelector('.full-screen-preview__frame').style.height = (window.innerHeight - headerDimensions) + 'px';
            }
