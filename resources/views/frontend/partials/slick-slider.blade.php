<div class="slick-slider slick-initialized slick-dotted" data-show="3" data-rtl="false">
    <div class="slick-list draggable">
        <div class="slick-track" style="opacity: 1; width: 5137px; transform: translate3d(-1401px, 0px, 0px);">
            <div class="slick-slide slick-cloned" data-slick-index="-3" id="" aria-hidden="true"
                style="width: 467px;" tabindex="-1">
                <div>
                    <div class="item slick-slide" style="width: 100%; display: inline-block;" aria-hidden="true">
                        <article class="default classic-large bg-box ctag ctag-2-html post-access-public">

                            <div class="epcl-flex">
                                <div class="meta meta-data small">
                                    <div class="tags fill-color">
                                        <a href="https://ghost.estudiopatagon.com/zento/tag/2-html/"
                                            class="primary-tag ctag ctag-2-html" data-id="ctag-2-html"
                                            tabindex="-1">HTML</a>
                                    </div>
                                    <a href="https://ghost.estudiopatagon.com/zento/author/jonathan-doe/" class="author"
                                        tabindex="-1">
                                        <img class="author-image cover" loading="lazy" fetchpriority="low"
                                            decoding="async"
                                            src="{{ asset('front_assets') }}/images/a-hiker-in-the-style-of-vibrant-illustrations-florianne-becker-light-violet-and-orange-deconstructed-tailoring-fauvismcore-minimal-1-65c0389ba903a-4.webp"
                                ...
                                <div class="info">
                                    <header>
                                        <h2 class="main-title title medium no-margin fw-bold underline-effect white">
                                            <a href="https://ghost.estudiopatagon.com/zento/introduction-to-html/"
                                                tabindex="-1">Introduction to HTML 📖</a>
                                        </h2>
                                        <a href="https://ghost.estudiopatagon.com/zento/introduction-to-html/"
                                            class="epcl-button black" tabindex="-1">Read
                                            More</a>
                                        <a href="https://ghost.estudiopatagon.com/zento/introduction-to-html/"
                                            class="access-icon visibility-members meta-info tooltip"
                                            data-title="Featured Article" aria-label="Featured Article" tabindex="-1">
            ...
            <div class="slick-slide slick-cloned" data-slick-index="-2" id="" aria-hidden="true"
                ...
                <div>
                    <div class="item slick-slide" style="width: 100%; display: inline-block;" aria-hidden="true">
                        <article class="default classic-large bg-box ctag ctag-3-css post-access-public">

                            <div class="epcl-flex">
                                <div class="meta meta-data small">
                                    <div class="tags fill-color">
                                        <a href="https://ghost.estudiopatagon.com/zento/tag/3-css/"
                                            class="primary-tag ctag ctag-3-css" data-id="ctag-3-css"
                                            tabindex="-1">CSS</a>
                                    </div>
                                    <a href="https://ghost.estudiopatagon.com/zento/author/jonathan-doe/" class="author"
                                        tabindex="-1">
                                ...
                                <div class="info">
                                    <header>
                                        <h2 class="main-title title medium no-margin fw-bold underline-effect white">
                                            <a href="https://ghost.estudiopatagon.com/zento/advanced-css-selectors-class-and-id/"
                                                tabindex="-1">CSS Selectors: Class and ID basic
                                                filtering for HTML elements</a>
                                        </h2>
                                        <a href="https://ghost.estudiopatagon.com/zento/advanced-css-selectors-class-and-id/"
                                            class="epcl-button black" tabindex="-1">Read
                                            More</a>
            ...
            <div class="slick-slide slick-cloned" data-slick-index="-1" id="" aria-hidden="true"
                ...
                <div>
                    <div class="item slick-slide" style="width: 100%; display: inline-block;" aria-hidden="true">
                        <article class="default classic-large bg-box ctag ctag-5-databases post-access-public">

                            <div class="epcl-flex">
                                <div class="meta meta-data small">
                                    <div class="tags fill-color">
                                        <a href="https://ghost.estudiopatagon.com/zento/tag/5-databases/"
                                            class="primary-tag ctag ctag-5-databases" data-id="ctag-5-databases"
                                            tabindex="-1">Databases</a>
                                    </div>
                                ...
                                <div class="info">
                                    <header>
                                        <h2 class="main-title title medium no-margin fw-bold underline-effect white">
                                            <a href="https://ghost.estudiopatagon.com/zento/introduction-to-dbms-and-sql/"
                                                tabindex="-1">Introduction to DBMS and SQL</a>
                                        </h2>
                                        <a href="https://ghost.estudiopatagon.com/zento/introduction-to-dbms-and-sql/"
                                            class="epcl-button black" tabindex="-1">Read
                                            More</a>
            ...
            <div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false"
                style="width: 467px;" role="tabpanel" id="slick-slide00">
                <div>
                    <div class="item slick-slide" style="width: 100%; display: inline-block;" aria-hidden="true">
                                ...
                                <div class="meta meta-data small">
                                    <div class="tags fill-color">
                                        <a href="https://ghost.estudiopatagon.com/zento/tag/1-fundamentals/"
                                            class="primary-tag ctag ctag-1-fundamentals" data-id="ctag-1-fundamentals"
                                            tabindex="0">Fundamentals</a>
                                    </div>
                                    <a href="https://ghost.estudiopatagon.com/zento/author/jonathan-doe/"
                                    ...
                                    <header>
                                        <h2 class="main-title title medium no-margin fw-bold underline-effect white">
                                            <a href="https://ghost.estudiopatagon.com/zento/vertical/"
                                                tabindex="0">Understanding how links works
                                                🚀</a>
                                        </h2>
                                        <a href="https://ghost.estudiopatagon.com/zento/vertical/"
                                            class="epcl-button black" tabindex="0">Read More</a>
                                        <a href="https://ghost.estudiopatagon.com/zento/vertical/"
                                            class="access-icon visibility-members meta-info tooltip"
                                            data-title="Featured Article" aria-label="Featured Article"
                                            tabindex="0">
            ...
            <div class="slick-slide slick-active" data-slick-index="1" aria-hidden="false" style="width: 467px;"
                            ...
                            <div class="epcl-flex">
                                ...
                                <div class="info">
                                    <header>
                                        <h2 class="main-title title medium no-margin fw-bold underline-effect white">
                                            <a href="https://ghost.estudiopatagon.com/zento/introduction-to-html/"
                                                tabindex="0">Introduction to HTML 📖</a>
                                        </h2>
                                        <a href="https://ghost.estudiopatagon.com/zento/introduction-to-html/"
                                            class="epcl-button black" tabindex="0">Read More</a>
                                        <a href="https://ghost.estudiopatagon.com/zento/introduction-to-html/"
            ...
            <div class="slick-slide slick-active" data-slick-index="2" aria-hidden="false" style="width: 467px;"
                            ...
                            <div class="epcl-flex">
                                ...
                                <div class="info">
                                    <header>
                                        <h2 class="main-title title medium no-margin fw-bold underline-effect white">
                                            <a href="https://ghost.estudiopatagon.com/zento/advanced-css-selectors-class-and-id/"
                                                tabindex="0">CSS Selectors: Class and ID basic
                                                filtering for HTML elements</a>
                                        </h2>
                                        <a href="https://ghost.estudiopatagon.com/zento/advanced-css-selectors-class-and-id/"
                                            class="epcl-button black" tabindex="0">Read More</a>
            ...
            <div class="slick-slide" data-slick-index="3" aria-hidden="true" style="width: 467px;" tabindex="-1"
                            ...
                            <div class="epcl-flex">
                                ...
                                <div class="info">
                                    <header>
                                        <h2 class="main-title title medium no-margin fw-bold underline-effect white">
                                            <a href="https://ghost.estudiopatagon.com/zento/vertical/"
                                                tabindex="-1">Understanding how links works
                                                🚀</a>
                                        </h2>
                                        <a href="https://ghost.estudiopatagon.com/zento/vertical/"
                                            class="epcl-button black" tabindex="-1">Read
