...
function (e, t) {
    ...
    var C = function (e) {
        var t, n, i, o, r, s, a, l, c, d, u, p, f, h, m, g, v, y, b, w = "sizzle" + 1 * new Date,
            x = e.document,
            k = 0,
            C = 0,
            T = le(),
                        ...
                        return 1 === i && 0 === o ? function (e) {
                            ...
                            if (g) {
                                ...
                                if (h = [s ? g.firstChild : g.lastChild], s && y) {
                                    for (b = (f = (c = (d = (u = (p = g)[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === k && c[1]) && c[2], p = f && g.childNodes[f]; p = ++f && p && p[m] || (b = f = 0) || h.pop();)
                                    ...
                                    for (;
                                        (p = ++f && p && p[m] || (b = f = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++b || (y && ((d = (u = p[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] = [k, b]), p !== t)););
        ...
        function Ce(e, t, n, i, o, r) {
            return i && !i[w] && (i = Ce(i)), o && !o[w] && (o = Ce(o, r)), ce((function (r, s, a, l) {
                var c, d, u, p = [],
                    ...
                    v = n ? o || (r ? e : h || i) ? [] : s : g;
                if (n && n(g, v, a, l), i)
                    for (c = ke(v, f), i(c, [], a, l), d = c.length; d--;)(u = c[d]) && (v[f[d]] = !(g[f[d]] = u));
                if (r) {
                    if (o || e) {
                        if (o) {
    ...
    (x.fn.init = function (e, t, n) {
        ...
        if (n = n || L, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof x ? t[0] : t, x.merge(this, x.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : g, !0)), $.test(i[1]) && x.isPlainObject(t))
    ...
    function be(e, t, n, i, o) {
        ...
        for (u.textContent = "", f = 0; r = p[f++];)
            ...
            else if (c = oe(r), s = ge(u.appendChild(r), "script"), c && ve(s), n)
        ...
        n ? (G.set(e, t, !1), x.event.add(e, t, {
            ...
            handler: function (e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    ...
                    else if (s = o.call(arguments), G.set(this, t, s), i = n(this, t), this[t](), s !== (r = G.get(this, t)) || i ? G.set(this, t, !1) : r = {}, s !== r) return e.stopImmediatePropagation(), e.preventDefault(), r && r.value
    ...
    x.event = {
        ...
        add: function (e, t, n, i, o) {
            ...
            if (X(e))
                for (n.handler && (n = (r = n).handler, o = r.selector), o && x.find.matchesSelector(ie, o), n.guid || (n.guid = x.guid++), (l = g.events) || (l = g.events = Object.create(null)), (s = g.handle) || (s = g.handle = function (t) {
        ...
        remove: function (e, t, n, i, o) {
            ...
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(P) || [""]).length; c--;)
                    if (f = m = (a = we.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f) {
    ...
    function He(e, t, n, i) {
        ...
        if (p && (s = (o = be(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = s), s || i)) {
            ...
            if (l)
                for (d = a[a.length - 1].ownerDocument, x.map(a, Oe), u = 0; u < l; u++) c = a[u], he.test(c.type || "") && !G.access(c, "globalEval") && x.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? x._evalUrl && !c.noModule && x._evalUrl(c.src, {
                    nonce: c.nonce || c.getAttribute("nonce")
                }, d) : y(c.textContent.replace($e, ""), c, d))
        }
        return e
    }
    ...
    x.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (t)
                if (n)
                    for (r = r || ge(e), s = s || ge(d), i = 0, o = r.length; i < o; i++) Ne(r[i], s[i]);
                else Ne(e, d);
    ...
    var Ke, et, tt, nt, it = /^(?:toggle|show|hide)$/,
        ot = /queueHooks$/;
    ...
    function ct(e, t, n) {
        ...
        for (function (e, t) {
                var n, i, o, r, s;
                for (n in e)
                    if (o = t[i = U(n)], r = e[n], Array.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (s = x.cssHooks[i]) && "expand" in s)
    ...
    x.Animation = x.extend(ct, {
        ...
        prefilters: [function (e, t, n) {
            ...
            for (i in n.queue || (null == (s = x._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                ...
                for (i in u && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = G.get(e, "display")), "none" === (d = x.css(e, "display")) && (c ? d = c : (ce([e], !0), c = e.style.display || c, d = x.css(e, "display"), ce([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === x.css(e, "float") && (l || (p.done((function () {
                        h.display = c
                    })), null == c && (d = h.display, c = "none" === d ? "" : d)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always((function () {
                        h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
                    }))), l = !1, f) l || (g ? "hidden" in g && (m = g.hidden) : g = G.access(e, "fxshow", {
                    display: c
                }), r && (g.hidden = !m), m && ce([e], !0), p.done((function () {
    ...
    x.fn.extend({
        ...
        hasClass: function (e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];)
                if (1 === n.nodeType && -1 < (" " + ht(mt(n)) + " ").indexOf(t)) return !0;
            return !1
        }
    });
    var vt = /\r/g;
    ...
    x.extend(x.event, {
        trigger: function (t, n, i, o) {
            ...
            if (s = f = a = i = i || g, 3 !== i.nodeType && 8 !== i.nodeType && !yt.test(y + x.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(), b.sort()), c = y.indexOf(":") < 0 && "on" + y, (t = t[x.expando] ? t : new x.Event(y, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : x.makeArray(n, [t]), p = x.event.special[y] || {}, o || !p.trigger || !1 !== p.trigger.apply(i, n))) {
                ...
                for (r = 0;
                    (s = v[r++]) && !t.isPropagationStopped();) f = s, t.type = 1 < r ? l : p.bindType || y, (u = (G.get(s, "events") || Object.create(null))[t.type] && G.get(s, "handle")) && u.apply(s, n), (u = c && s[c]) && u.apply && X(s) && (t.result = u.apply(s, n), !1 === t.result && t.preventDefault());
    ...
    Mt.href = wt.href, x.extend({
        ...
        ajax: function (t, n) {
            ...
            function S(t, n, s, l) {
                ...
                }(f, T, s)), !u && -1 < x.inArray("script", f.dataTypes) && x.inArray("json", f.dataTypes) < 0 && (f.converters["text script"] = function () {}), w = function (e, t, n, i) {
                    var o, r, s, a, l, c = {},
                        d = e.dataTypes.slice();
                    if (d[1])
...
})), jQuery.noConflict(), void 0 === jQuery.migrateMute && (jQuery.migrateMute = !0),
    function (e) {
        "use strict";
        ...
        e.event.props = [], e.event.fixHooks = {}, r(e.event.props, "concat", e.event.props.concat, "jQuery.event.props.concat() is deprecated and removed"), e.event.fix = function (t) {
            var n, i = t.type,
                ...
                s = e.event.props;
            if (s.length)
                for (o("jQuery.event.props are deprecated and removed: " + s.join()); s.length;) e.event.addProp(s.pop());
            if (r && !r._migrated_ && (r._migrated_ = !0, o("jQuery.event.fixHooks are deprecated and removed: " + i), (s = r.props) && s.length))
        ...
        var e = {
                163: e => {
                    e.exports = function (e) {
                        ...
                        function a(t, i) {
                            var o, r, c, d = i.appendChild((o = t, r = document.createElement("li"), c = document.createElement("a"), e.listItemClass && r.setAttribute("class", e.listItemClass), e.onClick && (c.onclick = e.onClick), e.includeTitleTags && c.setAttribute("title", o.textContent), e.includeHtml && o.childNodes.length ? n.call(o.childNodes, (function (e) {
            ...
            open: function (n) {
                ...
                if (i || (i = e(document.body)), !1 === n.isObj) {
                    ...
                    for (r = 0; l.length > r; r++)
                        if ((a = l[r]).parsed && (a = a.el[0]), a === n.el[0]) {
                            t.index = r;
                            break
                        }
...
document.addEventListener("DOMContentLoaded", (function () {
    ...
    function (e) {
        e(window).on("load", (function () {
            ...
            var n = '<span title="%title%" class="mfp-close">&times;</span>',
            ...
            document.querySelectorAll(".kg-gallery-image img").forEach((function (e) {
                ...
                var i = parseInt(e(this).data("show")),
                    o = !1;
                ...
                var n = t.target.value,
                    i = e(this).data("class"),
                    o = String(e(this).data("target")),
                    r = String(e(this).data("attr"));
                "undefined" !== i && "undefined" !== r ? e(i).css(r, n) : e(":root").css({
                    [o]: n
                })
            }))
